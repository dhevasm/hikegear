        ...
        <div class="navbar-link-top navbar-link-top-desktop">
          <div class="navbar-link-top-right">
           <a href="index.html">Home</a>
            <a href="5-Revan Agus Widyantara/about.html">About</a>
...
<footer class="footer">
      <div class="footer-container">
        <div class="footer-section">
          ...
          <a href="5-Revan Agus Widyantara/about.html">Sustainability</a>
        </div>
        <div class="footer-section">
          <h4>Bantuan</h4>
...
function filterProducts() {
    ...
    filteredProducts.forEach(product => {
        ...
        suggestionDiv.onclick = () => {
            window.location.href = `3-Shynde Aditya Maulana/detail.html?product=${product.name}`;
        };
